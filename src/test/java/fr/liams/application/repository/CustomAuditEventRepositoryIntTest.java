package fr.liams.application.repository;

import fr.liams.application.LiamsApp;
import fr.liams.application.config.Constants;
import fr.liams.application.config.audit.AuditEventConverter;
import fr.liams.application.domain.PersistentAuditEvent;
...
import static fr.liams.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
